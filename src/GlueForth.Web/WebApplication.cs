...
namespace GlueForth.Web {
    ...
    private DevExpress.ExpressApp.Validation.Web.ValidationAspNetModule validationAspNetModule;
        ...
        static BlueNorthAspNetApplication() {
        ...
        #endregion
        public BlueNorthAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void BlueNorthAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.BlueNorthAspNetApplication_DatabaseVersionMismatch);
