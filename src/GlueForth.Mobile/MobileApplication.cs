...
namespace GlueForth.Mobile {
    ...
    public partial class BlueNorthMobileApplication : MobileApplication {
        ...
        static BlueNorthMobileApplication() {
        ...
        #endregion
        public BlueNorthMobileApplication() {
        ...
        private void BlueNorthMobileApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.BlueNorthMobileApplication_DatabaseVersionMismatch);
